<div class="flex flex-row gap-8 items-center justify-around p-24">
    ...
    <button type="button" wire:click="cashOut" :disabled="{{$errorMessage !== null || $hasSpun !== true}}" class="bg-stone-500 disabled:opacity-40 text-white px-16 py-4 rounded-md text-lg">Cash Out</button>
